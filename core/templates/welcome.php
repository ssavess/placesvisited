...
<div class="cpotheme-welcome">
	...
	<div class="cpotheme-welcome-section">
		<div class="cpotheme-welcome-column">
			<h3>1. <?php _e('Install CPO Content Types', 'brilliance'); ?></h3>
			<p>
				<?php _e('It is highly recommended that you install the CPO Content Types plugin. It will help you manage all the special content types that this theme supports.', 'brilliance'); ?>
			</p>
	...
	<div class="cpotheme-welcome-section">
		<div class="cpotheme-welcome-block cpotheme-welcome-block-wide">
			...
			<h3 class="cpotheme-welcome-block-title"><?php _e('Forge, a front-end page builder', 'brilliance'); ?></h3>
			<div class="cpotheme-welcome-block-body">
				<p>
					<?php _e('Design virtually any kind of layout with a drag & drop interface, right on the design of your site. No coding required.', 'brilliance'); ?>
				</p>
				...
				<a class="button button-primary thickbox" href="<?php echo $plugin_url; ?>'"><?php _e('Install Forge', 'brilliance'); ?></a>
			</div>
		</div>
		<div class="cpotheme-welcome-block">
			...
			<h3 class="cpotheme-welcome-block-title"><?php _e('Add reusable content with Infuse', 'brilliance'); ?></h3>
			<div class="cpotheme-welcome-block-body">
				<p>
					<?php _e('Create a site-wide announcement, add content to the homepage, or recycle the same blocks of content across many pages.', 'brilliance'); ?>
				</p>
				...
				<a class="button button-primary thickbox" href="<?php echo $plugin_url; ?>'"><?php _e('Install Infuse', 'brilliance'); ?></a>
			</div>
		</div>
		<div class="cpotheme-welcome-block cpotheme-welcome-block-last">
			...
			<h3 class="cpotheme-welcome-block-title"><?php _e('Insert multimedia elements with CPO Shortcodes', 'brilliance'); ?></h3>
			<div class="cpotheme-welcome-block-body">
				<p>
					<?php _e('Add buttons, pricing tables, icon boxes, and even grid-like post listings much more thanks to the power of shortcodes.', 'brilliance'); ?>
				</p>
				...
				<a class="button button-primary thickbox" href="<?php echo $plugin_url; ?>'"><?php _e('Install CPO Shortcodes', 'brilliance'); ?></a>
			</div>
		</div>
		<div class="cpotheme-welcome-block">
			<img class="cpotheme-welcome-block-image" src="<?php echo esc_url(CPOTHEME_CORELITE_URL).'/images/plugin-cpo-widgets.jpg'; ?>">
			<h3 class="cpotheme-welcome-block-title"><?php _e('Add essential widgets with CPO Widgets', 'brilliance'); ?></h3>
			<div class="cpotheme-welcome-block-body">
				<p>
					<?php _e('Display images in your latest posts widget, add your most recent tweets, link your social profiles, and much more.', 'brilliance'); ?>
				</p>
				...
				<a class="button button-primary thickbox" href="<?php echo $plugin_url; ?>'"><?php _e('Install CPO Widgets', 'brilliance'); ?></a>
			</div>
		</div>
		<div class="cpotheme-welcome-block cpotheme-welcome-block-last">
			<img class="cpotheme-welcome-block-image" src="<?php echo esc_url(CPOTHEME_CORELITE_URL).'/images/plugin-cpo-content-types.jpg'; ?>">
			<h3 class="cpotheme-welcome-block-title"><?php _e('Need help? Check the knowledge base', 'brilliance'); ?></h3>
			<div class="cpotheme-welcome-block-body">
				<p>
					<?php printf(__('Check out the extensive documentation pages and see what you can achieve with %s.', 'brilliance'), esc_attr(CPOTHEME_NAME)); ?>
				</p>
				<a class="button button-primary" target="_blank" href="<?php echo esc_url('//www.cpothemes.com/documentation'); ?>"><?php _e('Read The Docs', 'brilliance'); ?></a>
			</div>
		</div>
		<div class="cpotheme-welcome-column cpotheme-welcome-column-last">
