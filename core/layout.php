...
function cpotheme_init_sidebar(){
    ...
    register_sidebar(array('name' => __('Default Widgets', 'brilliance'),
    'id' => 'primary-widgets',
    'description' => __('Sidebar shown in all standard pages by default.', 'brilliance'),
    'before_widget' => '<div id="%1$s" class="widget %2$s">',
    'after_widget' => '</div>',
    'before_title' => '<div class="widget-title heading">',
    'after_title' => '</div>'));
	
	register_sidebar(array('name' => __('Secondary Widgets', 'brilliance'),
    'id' => 'secondary-widgets',
    'description' => __('Shown in pages with more than one sidebar.', 'brilliance'),
    'before_widget' => '<div id="%1$s" class="widget %2$s">',
    'after_widget' => '</div>',
    'before_title' => '<div class="widget-title heading">',
    'after_title' => '</div>'));
	...
	for($count = 1; $count <= $footer_columns; $count++){
		...
		'name' => __('Footer Widgets', 'brilliance').' '.$count,
		'description' => __('Shown in the footer area.', 'brilliance'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<div class="widget-title heading">',
		'after_title' => '</div>'));
...
function cpotheme_init_menu(){
	...
	'top_menu' => __('Top Menu', 'brilliance'),
    'main_menu' => __('Main Menu', 'brilliance'),
    'footer_menu' => __('Footer Menu', 'brilliance')
	));
}