...
if(!function_exists('cpotheme_metadata_layoutstyle')){
	function cpotheme_metadata_layoutstyle(){
		$data = array(
		'fixed' => __('Full Width', 'brilliance'),
		'boxed' => __('Boxed', 'brilliance'));
		return $data;
	}
}
...
function cpotheme_metadata_featured_page(){
	$data = array(
	'none' => __('None', 'brilliance'),
	'slider' => __('In The Slider', 'brilliance'),
	'features' => __('In The Featured Boxes', 'brilliance'));
