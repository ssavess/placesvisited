...
function cpotheme_metadata_layout_options(){
	...
	'name' => 'layout_sidebar',
	'label' => __('Sidebar Position', 'brilliance'),
	'desc' => __('Determines the location of the sidebar by default.', 'brilliance'),
	'type' => 'imagelist',
...
function cpotheme_metadata_feature_options(){
	...
	'name' => 'feature_icon',
	'std'  => '',
	'label' => __('Feature Icon', 'brilliance'),
	'desc' => __('Sets an icon to be used as the featured element.', 'brilliance'),
	'type' => 'iconlist');
...
function cpotheme_metadata_portfolio_options(){
	...
	'std'  => '',
	'label' => __('Featured Item', 'brilliance'),
	'desc' => __('Specifies whether this item appears in the homepage.', 'brilliance'),
	'type' => 'yesno');
...
function cpotheme_metadata_service_options(){
	...
	'name' => 'service_icon',
	'std'  => '',
	'label' => __('Service Icon', 'brilliance'),
	'desc' => __('Sets an icon to be used as the service preview.', 'brilliance'),
	'type' => 'iconlist');
...
function cpotheme_metadata_team_options(){
	...
	'name' => 'team_featured',
	'std'  => '',
	'label' => __('Featured Member', 'brilliance'),
	'desc' => __('Specifies whether this member appears in the homepage.', 'brilliance'),
	'type' => 'yesno');
...
function cpotheme_metadata_page_options(){
	...
	'name' => 'page_featured',
	'std'  => '',
	'label' => __('Show In Homepage', 'brilliance'),
	'desc' => __('Specifies whether this item is featured in the homepage.', 'brilliance'),
	'type' => 'select',
